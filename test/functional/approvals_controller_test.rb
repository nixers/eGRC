...
class ApprovalsControllerTest < ActionController::TestCase
  ...
  test "should create approval" do
    assert_difference('Approval.count') do
      post :create, approval: { name: @approval.name, responsible: @approval.responsible, status: @approval.status, string: @approval.string, version: @approval.version }
    end
  ...
  test "should update approval" do
    put :update, id: @approval, approval: { name: @approval.name, responsible: @approval.responsible, status: @approval.status, string: @approval.string, version: @approval.version }
    assert_redirected_to approval_path(assigns(:approval))
  end
